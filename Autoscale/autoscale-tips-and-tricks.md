...
<ol>
  ...
  <li>Login to the dedicated load balancer's web-based management page and follow the instructions for [Dedicated Load Balancer Basic Management](../Network/dedicated-load-balancer-basic-management.md) to
