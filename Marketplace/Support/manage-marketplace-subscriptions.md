...
Ex. Customer has a 10 license seat subscription and wants to add 10 additional 10 license seats.

The customer can also use the Update option to downgrade their subscription:
Ex. Customer has a 100 license seat subscription and wants to downgrade to a 80 license seat subscription.
...
5. The Provider of the Service that you requested an update for will contact you via email to communicate that your request has been fulfilled and the date that the new functionality and updated billing will begin.

###Terminate
The **Terminate** button allows customers to terminate their Marketplace subscriptions that do NOT have an active term commit associated with them. If there is an active term commit associated with the subscription the terminate button will not populate for that subscription until 30 days prior to the end of the term commit date. For subscriptions with term commits, you will be notified via email 30 days prior to your term commit end date. If you chose to keep the service no action is needed on your part and the subscription will auto-renew for the same terms. If you wish to terminate the subscription you must do so via the Terminate request prior to the term commit end date.
...
5. The Provider of the Subscription that you requested a termination for will contact you via email to communicate that your termination request has been fulfilled and the date that billing will end.
