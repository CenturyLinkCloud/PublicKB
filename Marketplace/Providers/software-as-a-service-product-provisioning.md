...
Software Providers that are classified as Software as a Service (SaaS) need to implement the steps outlined in the [API documentation](../../marketplace/providers/software-as-a-service-saas-v2-api.md).  
