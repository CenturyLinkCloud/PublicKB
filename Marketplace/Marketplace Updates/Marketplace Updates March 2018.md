...
Today IR Prognosis experience management solutions for payment hubs, unified communications ecosystems and contact centers are trusted by Fortune 500 companies to keep their business running. A brief description of the IR offerings available on the CenturyLink Marketplace can be found [here](https://www.ctl.io/marketplace/partner/ZTYJ/). IR was also a featured Provider on the CenturyLink Marketplace Spotlight Blog series. You can read the blog [here](https://www.ctl.io/blog/post/customer-experience-testing-from-ir/).
