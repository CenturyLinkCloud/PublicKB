...
Alternately, you can open a ticket with Customer Care asking for your OpenVPN sedrver to be rebuilt using a newer version of OpenVPN.  Due to the workflow of creating a new server, all your existing certs will be deleted.  New certs will need to be downloaded to any VPN clients accessing the Cloud servers.
