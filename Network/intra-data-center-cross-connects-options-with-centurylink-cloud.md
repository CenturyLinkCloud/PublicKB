...
Once a purchasing decision is made, the following will need to be ascertained/submitted:
  ...
  * Will the cross connect be deployed within one of [the data centers/campuses.](../CenturyLinkCloud/centurylink-cloud-data-center-locations.md)
