...
1. **Download and install the latest OpenVPN client for Windows**
  1. Download the OPenVPN client 2.3.18-I602 64-bit release (for Vista and later) from the [OpenVPN client](https://openvpn.net/index.php/open-source/downloads.html) website.  There is currently a known issue when using OpevnVPN client version 2.4.5.
