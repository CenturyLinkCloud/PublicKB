{{{
  "title": "Master Article - Migration from VMware to AWS",
  "date": "04-06-2018",
  "author": "Anshul Arora",
  "attachments": [],
  "contentIsHTML": false,
...
## Article Overview
This article provides step by step links on how to migrate a VM from VMware Data Center on AWS datacenter
...
4. [Create Production SRN in vCenter](../SafeHaven 5 VMware to AWS/Create-Production-SRN-in-vCenter.md)
...
8. [Register Datacenters within SafeHaven Console](../SafeHaven 5 VMware to AWS/Register-vcenter-SafeHaven Console.md)
...
11. [Add and Claim Storage on Production SRN in VMWare Data Center](../SafeHaven 5 VMware to AWS/Add-and-Claim-Storage-on-Production-SRN-vmware.md)

12. [Create Windows Protection Group,Install LRA and Start Replication](../SafeHaven 5 VMware to AWS/Create-Windows-PG-VMWare.md)
...
13. [Create Linux Protection Group](../SafeHaven 5 VMware to AWS/Create-Linux-Protection-Group-vcenter.md)
