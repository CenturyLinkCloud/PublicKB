...
Production Servers can either be Windows or Linux. Please refer to [SafeHaven 5.0 Use Case and Support Matrix](../../GeneralSafeHaven-5.0-Use-Case-and-Support-Matrix.md) for more information.
