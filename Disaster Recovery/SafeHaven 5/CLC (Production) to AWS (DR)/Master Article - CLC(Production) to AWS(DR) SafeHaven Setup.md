...
8. [Register Datacenters within SafeHaven Console](Register Datacenters within SafeHaven Console.md)
...
12. [Create Windows Protection Group,Install LRA and Start Replication](Create Windows Protection Group, Install LRA and Start Replication.md)
	...
	a. [Modify WAN Replication Rate and Check Replication Status](Modify WAN Replication Rate and check Replication Status.md)
...
13. [Create Linux Protection Group](Create Linux Protection Group.md)
    ...
    b. [Modify WAN Replication Rate](Modify WAN Replication Rate and check Replication Status.md)
