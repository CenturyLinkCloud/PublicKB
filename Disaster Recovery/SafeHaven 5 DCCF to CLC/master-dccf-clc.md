...
### Article Overview
This article explains how to setup SafeHaven at a high level and use SafeHaven for recovery with all the KB article links in order for DCC-F to CLC use case. To read more about a manual site click [here](../SafeHaven 5 Manual to AWS/to Manual Site.md)
