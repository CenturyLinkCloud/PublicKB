...
Issues scanning the QR code for multi-factor.|Please review [this KB article regarding multi-factor authentication](lumen-master-account-multi-factor-authentication.md).
