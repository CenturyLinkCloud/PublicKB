...
By default, all public and private cloud providers are enabled for ElasticBox users. As an ElasticBox administrator, you can enable or disable providers for the entire organization in the [admin console](https://www.ctl.io/knowledge-base/ElasticBox/admin-overview.md/). You can turn off a particular provider if you don’t want people to deploy to it.
