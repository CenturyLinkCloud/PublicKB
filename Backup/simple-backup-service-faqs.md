...
A: All Operating Systems that are currently buildable in the CenturyLink Cloud Control Portal are supported, with the exception of RedHat Enterprise linux 5. Customer imported OVA/OVF OSes and 32-bit OSes are not supported.
