...
Check out our SBS product page [here](//www.ctl.io/simple-backup-service/). The CenturyLink Cloud [Knowledge Base](../backup/#1) also has a number of articles on backup, including [Getting Started with Simple Backup](../backup/getting-started-with-simple-backup/) and [Simple Backup How It Works](../backup/simple-backup-service-how-it-works/).
