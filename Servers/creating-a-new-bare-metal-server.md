...
4. Now, choose the operating system for this server. Bare Metal servers offer a subset of the OS templates offered for virtual machines on CenturyLink Cloud: Windows 2012 R2 Standard, Red Hat 7, and CentOS 7.
