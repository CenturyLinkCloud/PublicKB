...
CenturyLink Cloud’s comprehensive, secure, and global cloud platform is built for business &mdash; and we back it with business-class support options. Our reseller partner’s choose from the two different Support Tiers:
* **Professional**
* **Enterprise**
...
3. After you sign up, you will receive a welcome email from noc@ctl.io for verification. Click the verification link and choose your password. Your account is active right away.
...
* [Learn More About What to Expect form a Security Issue](../what-can-you-expect-from-tier-3-on-a-security-issue.md)
...
1. Visit the [Status page](http://status.ctl.io/).
...
Where to learn more about *Your Platform in Motion*:
* [CenturyLink Cloud Website](http://www.ctl.io/)
* [Support Options](http://www.ctl.io/support)
