...
<img src="//d33np9n32j53g7.cloudfront.net/assets/stacks/prestashop/img/prestashop-stack-110x117-2dd0c3620625b4f07badbf556115287b.png" style="border:0;float:right;max-width:250px">

After reading this article, the reader should feel comfortable deploying the PrestaShop stack by Bitnami.
...
1. **Locate the Blueprint in the Blueprint Library**
  ...
  Starting from the CenturyLink Control Panel, navigate to the Blueprints Library. Search for **PrestaShop on linux_TITLE** in the keyword search on the right side of the page.
...
2. ** Select to Execute the Package on a Server Group**
  ...
  Packages can be executed on one more more servers in a group.  Search for the public script package named **Install PrestaShop on linux_TITLE**.
