...
### Partner Profile
SoftNAS, LLC is a leading storage software company that provides Simply Powerfulª agile storage software that protects business data in the cloud.
...
- Support Web: https://www.softnas.com/wp/support/
- Sales Email: sales@softnas.com
...
SoftNAS Cloud operates on an industry-standard Linux platform, and uses a derivative of the Zettabyte File Systemª (ZFS). This makes SoftNAS Cloud able to leverage many ZFS features and add layers of functionality for NAS solutions in virtual computing and cloud computing.
...
SoftNAS Cloud is packaged with a primary administration interface called SoftNAS StorageCenterª, which provides commercial-grade storage administration and management functionalities for businesses of all sizes.
...
- Import CenturyLink Ecosystem Partner Source Image: SoftNAS-VMware3.3.1.ova
