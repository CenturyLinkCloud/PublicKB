...
Osclass is your one-stop shop to building your own classifieds marketplace. Create a site with real estate ads, job listings, car classifieds, rentals, or just about anything you can imagine. With dozens of templates, themes and plugins, Osclass is fully customizable. After launching Osclass with Bitnami, be sure to check out the showcase on the Oeoego website (makers of Ossclass) to see stellar examples of Osclass in action.

### Description

Through the CenturyLink Blueprint integration, Bitnami Osclass Stack provides a click-through solution to install and configure Osclass on the Linux platform.

For more information, please visit http://osclass.org
...
### Install Bitnami Osclass Stack on Linux Blueprint
1. Locate the Bitnami Osclass Stack Blueprint
  1. Starting from the CenturyLink Control Panel, navigate to the Blueprints Library.
  2. Search for “Osclass” in the keyword search on the right side of the page.
  3. Locate the 'Install Bitnami Osclass on Linux' Blueprint

2. Choose and Deploy the Blueprint. Click the “Install Bitnami Osclass on Linux” Blueprint.
