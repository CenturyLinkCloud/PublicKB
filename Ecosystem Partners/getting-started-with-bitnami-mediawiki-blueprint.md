...
Through the CenturyLink Blueprint integration, Bitnami MediaWiki Stack provides a click-through solution to install and configure MediaWiki on the Linux platform.

For more information, please visit http://www.mediawiki.org/wiki/MediaWiki
...
### Install Bitnami MediaWiki Stack on Linux Blueprint
1. Locate the Bitnami MediaWiki Stack Blueprint
  1. Starting from the CenturyLink Control Panel, navigate to the Blueprints Library.
  2. Search for “MediaWiki” in the keyword search on the right side of the page.
  3. Locate the 'Install Bitnami MediaWiki on Linux' Blueprint

2. Choose and Deploy the Blueprint. Click the “Install Bitnami MediaWiki on Linux” Blueprint.
