...
![Pootle Logo](../../images/pootle-stack-logo.png)
...
1. Locate the Bitnami Pootle Stack Blueprint.
   ...
   * Search for 'Pootle' in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami Pootle on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the 'Install Bitnami Pootle on Linux' Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Pootle installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named 'Install Bitnami Pootle on Linux'.
