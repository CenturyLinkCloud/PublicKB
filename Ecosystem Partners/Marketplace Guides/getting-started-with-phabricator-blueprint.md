...
![Phabricator Logo](../../images/phabricator-stack-logo.png)
...
1. Locate the Bitnami Phabricator Stack Blueprint.
   ...
   * Search for “Phabricator” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami Phabricator on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami Phabricator on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Phabricator installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami Phabricator on Linux**.
