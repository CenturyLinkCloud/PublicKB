...
Through the CenturyLink Blueprint integration, Bitnami SimpleInvoices Stack provides a click-through solution to install and configure SimpleInvoices on the Linux platform.
...
1. **Locate the Bitnami SimpleInvoices Stack Blueprint**
...
Bitnami SimpleInvoices Stack is available as a Script Package for deployment on an existing server based on your own sizing requirements or to support more advanced configurations such as customized Blueprint Workflows to repeatably deploy multiple stacks on servers.
