...
![CiviCRM Logo](../../images/civicrm-stack-logo.png)
...
For more information, please visit [CiviCRM](http://civicrm.org).
...
1. Locate the CiviCRM Blueprint.
   ...
   * Search for “CiviCRM” in the keyword search on the right side of the page.
   * Locate the 'Install CiviCRM on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the 'Install CiviCRM on Linux' Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for CiviCRM installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install CiviCRM on Linux**.
