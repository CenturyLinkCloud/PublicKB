...
![Chyrp Logo](../../images/chyrp-stack-logo.png)
...
1. Locate the Chyrp Blueprint.
   ...
   * Search for “Chyrp” in the keyword search on the right side of the page.
   * Locate the 'Install Chyrp on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Chyrp on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Chyrp installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Chyrp on Linux**.
