...
![Liferay logo](https://bitnami.com/assets/stacks/liferay/img/liferay-stack-220x234.png)
...
1. **Locate the Liferay Stack Blueprint**
  ...
  2. Search for “Liferay” in the keyword search on the right side of the page.
  3. Locate the 'Install Liferay on Linux' Blueprint
...
2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Liferay on Linux**.
