...
![PrestaShop Logo](../../images/prestashop-stack-logo.png)
...
1. Locate the PrestaShop Stack Blueprint.
   ...
   * Search for 'PrestaShop' in the keyword search on the right side of the page.
   * Locate the 'Install PrestaShop on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the 'Install PrestaShop on Linux' Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for PrestaShop installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named 'Install PrestaShop on Linux'.
