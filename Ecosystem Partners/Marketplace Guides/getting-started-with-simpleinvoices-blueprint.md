...
![SimpleInvoices Logo](../../images/simpleinvoices-stack-logo.png)
...
1. Locate the Bitnami SimpleInvoices Blueprint.
   ...
   * Search for “SimpleInvoices” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami Tiny Tiny RSS on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami SimpleInvoices on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for SimpleInvoices installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami SimpleInvoices on Linux**.
