...
![MEAN logo](../../images/meanstack-stack-logo.png)
...
2. Choose and Deploy the Blueprint.
   * Click the “Install MEAN on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for MEAN installation. The Operating system must be supported by the Script Package.
