...
![X2Engine Sales CRM logo](../../images/x2engine-stack-logo.png)
...
1. Locate the Bitnami X2Engine Sales CRM Blueprint.
   ...
   * Search for “X2Engine Sales CRM” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami X2Engine Sales CRM on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami X2Engine Sales CRM on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for X2Engine Sales CRM installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami X2Engine Sales CRM on Linux**.
