...
1. **Locate the Drupal Stack Blueprint**
  ...
  3. Locate the 'Install Drupal on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Drupal on Linux” Blueprint.**
...
Identify the server targeted for Drupal installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Drupal on Linux**.
