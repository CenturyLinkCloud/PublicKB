...
![LimeSurvey logo](https://bitnami.com/assets/stacks/limesurvey/img/limesurvey-stack-220x234.png)
...
1. **Locate the Bitnami LimeSurvey Stack Blueprint**
  ...
  2. Search for “LimeSurvey” in the keyword search on the right side of the page.
  3. Locate the 'Install Bitnami LimeSurvey on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Bitnami LimeSurvey on Linux” Blueprint.**
...
Bitnami LimeSurvey Stack is available as a Script Package for deployment on an existing server based on your own sizing requirements or to support more advanced configurations such as customized Blueprint Workflows to repeatably deploy multiple stacks on servers.
...
2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Bitnami LimeSurvey on Linux**.
