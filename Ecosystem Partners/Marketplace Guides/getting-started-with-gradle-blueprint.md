...
![Gradle logo](https://bitnami.com/assets/stacks/gradle/img/gradle-stack-220x234.png)
...
1. **Locate the Gradle Stack Blueprint**
  ...
  2. Search for “Gradle” in the keyword search on the right side of the page.
  3. Locate the 'Install Gradle on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Gradle on Linux” Blueprint.**
...
Identify the server targeted for Gradle installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Gradle on Linux**.
...
Set the following application parameters: None
