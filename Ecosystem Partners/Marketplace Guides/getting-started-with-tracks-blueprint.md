{{{
  "title": "Getting Started with Tracks - Blueprint",
  "date": "10-01-2015",
...
![Tracks logo](https://bitnami.com/assets/stacks/tracks/img/tracks-stack-220x234.png)

### Technology Profile

Ready to take your personal productivity to the next level? If you're like a lot of productivity junkies, you've probably read David Allen's book, Getting Things DoneTM . Tracks is a Rails based app built to help you put the Getting Things Done plan into action. Tracks can be set up for multiple users for collaboration and group work.
...
### Deploying Tracks on a New Server
...
2. **Choose and Deploy the Blueprint. Click the “Install Bitnami Tracks on Linux” Blueprint.**
...
Identify the server targeted for Tracks installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Bitnami Tracks on Linux**.
