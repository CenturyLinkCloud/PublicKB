...
![Tracks Logo](../../images/tracks-stack-logo.png)

### Technology Profile
Ready to take your personal productivity to the next level? If you're like a lot of productivity junkies, you've probably read David Allen's book, Getting Things Done(TM). Tracks is a Rails based app built to help you put the Getting Things Done plan into action. Tracks can be set up for multiple users for collaboration and group work.
...
2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami Tracks on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Tracks installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami Tracks on Linux**.
