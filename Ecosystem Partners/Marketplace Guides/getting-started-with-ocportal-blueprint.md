...
![ocPortal Logo](../../images/ocportal-stack-logo.png)
...
2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami ocPortal on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for ocPortal installation.
