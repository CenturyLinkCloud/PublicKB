...
![JBoss logo](https://bitnami.com/assets/stacks/jboss/img/jboss-stack-220x234.png)
...
### Description
This CenturyLink Blueprint iprovides a click-through solution to install and configure JBoss on the Linux platform.

For more information, please visit [http://www.jboss.org/](http://www.jboss.org/)
...
1. **Locate the JBoss Stack Blueprint**
  ...
  3. Locate the 'Install JBoss on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install JBoss on Linux” Blueprint.**
...
Identify the server targeted for JBoss installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install JBoss on Linux**.
