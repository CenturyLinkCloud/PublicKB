...
![Diaspora logo](../../images/diaspora-stack-logo.png)
...
For more information, please visit [Diaspora Foundation](http://www.diasporafoundation.org/).
...
1. Locate the Diaspora Stack Blueprint.
   ...
   * Search for “Diaspora” in the keyword search on the right side of the page.
   * Locate the 'Install Diaspora on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Diaspora on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Diaspora installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Diaspora on Linux**.
