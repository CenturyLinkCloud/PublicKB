...
![ThinkUp Logo](../../images/thinkup-stack-logo.png)
...
1. Locate the Bitnami ThinkUp Blueprint.
   ...
   * Search for “ThinkUp” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami ThinkUp on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   Click the “Install Bitnami ThinkUp on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for ThinkUp installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami ThinkUp on Linux**.
