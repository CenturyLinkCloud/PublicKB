...
![Elasticsearch logo](https://bitnami.com/assets/stacks/elasticsearch/img/elasticsearch-stack-220x234.png)
...
1. **Locate the Elasticsearch Stack Blueprint**
  ...
  2. Search for “Elasticsearch” in the keyword search on the right side of the page.
  3. Locate the 'Install Elasticsearch on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Elasticsearch on Linux” Blueprint.**
...
Complete the information below:
  ...
  3. SSL Port, e.g. 443
  4. Elasticsearch node host, e.g. 127.0.0.1
...
Identify the server targeted for Elasticsearch installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Elasticsearch on Linux**.
