...
![Subversion logo](../../images/subversion-stack-logo.png)
...
1. Locate the Subversion Stack Blueprint.
   ...
   * Search for “Subversion” in the keyword search on the right side of the page.
   * Locate the 'Install Subversion on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Subversion on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Subversion installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Subversion on Linux**.
