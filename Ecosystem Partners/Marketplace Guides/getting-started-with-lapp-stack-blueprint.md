...
2. Choose and Deploy the Blueprint.
   * Click the “Install LAPP Stack on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for LAPP Stack installation. The Operating system must be supported by the Script Package.
