...
1. Locate the Joomla! Stack Blueprint.
   ...
   * Search for “Joomla!” in the keyword search on the right side of the page.
   * Locate the 'Install Joomla! on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Joomla! on Linux” Blueprint.

3. Configure the Blueprint.
   Complete the information below:

   * Execute on Server: Select a Linux x64 server to deploy the Blueprint on.
   * Site name, e.g., user's Site!
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Joomla! installation.
