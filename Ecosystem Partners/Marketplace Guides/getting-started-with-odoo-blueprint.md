...
For more information, please visit [OpenERP](http://www.openerp.com/).
...
1. Locate the Odoo Stack Blueprint.
   ...
   * Search for “Odoo” in the keyword search on the right side of the page.
   * Locate the 'Install Odoo on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Odoo on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Odoo installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named Install Odoo on Linux.
