...
![Tiki Wiki CMS Groupware Logo](../../images/tiki-stack-logo.png)
...
2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami Tiki Wiki CMS Groupware on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Tiki Wiki CMS Groupware installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami Tiki Wiki CMS Groupware on Linux**.
