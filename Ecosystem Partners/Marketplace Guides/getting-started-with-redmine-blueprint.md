...
For more information, please visit [http://www.redmine.org/](http://www.redmine.org/)
...
1. **Locate the Redmine Stack Blueprint**
  ...
  3. Locate the 'Install Redmine on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Redmine on Linux” Blueprint.**
...
Identify the server targeted for Redmine installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Redmine on Linux**.
