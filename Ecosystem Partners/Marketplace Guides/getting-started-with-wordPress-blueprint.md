...
![WordPress Logo](../../images/wordpress-stack-logo.png)
...
1. Locate the WordPress Stack Blueprint.
   ...
   * Search for “WordPress” in the keyword search on the right side of the page.
   * Locate the 'Install WordPress on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install WordPress on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for WordPress installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install WordPress on Linux**.
