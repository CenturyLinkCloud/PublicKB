...
<img alt="ownCloud Logo" src="/knowledge-base/images/bitnami_logos/owncloud-stack-110x117-8e1ce1fe56397d6182b8e624dbcf4af7.png" style="border:0;float:right;max-width:250px">
...
1. **Locate the Blueprint in the Blueprint Library**
  ...
  Starting from the CenturyLink Control Panel, navigate to the Blueprints Library. Search for **ownCloud on Linux** in the keyword search on the right side of the page.
...
2. **Select to Execute the Package on a Server Group**
  ...
  Packages can be executed on one more more servers in a group.  Search for the public script package named **Install ownCloud on Linux**.
