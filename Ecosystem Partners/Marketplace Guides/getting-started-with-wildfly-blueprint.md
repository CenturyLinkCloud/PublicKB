...
![WildFly Logo](../../images/wildfly-stack-logo.png)
...
For more information, please visit [Wildfly](http://www.wildfly.org/).
...
1. Locate the WildFly Stack Blueprint.
   ...
   * Search for “WildFly” in the keyword search on the right side of the page.
   * Locate the 'Install WildFly on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install WildFly on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for WildFly installation.
...
2. Select to Execute the Package on a Server Group,
   ...
   * Search for the public script package named **Install WildFly on Linux**.
