...
![Review Board logo](../../images/reviewboard-stack-logo.png)
...
2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami Review Board on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Review Board installation.
