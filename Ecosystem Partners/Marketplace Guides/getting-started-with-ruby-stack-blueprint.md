...
![Ruby Stack logo](../../images/rubystack-stack-logo.png)
...
For more information, please visit [Ruby Lang](http://www.ruby-lang.org).
...
1. Locate the Ruby Stack Stack Blueprint.
   ...
   * Search for “Ruby Stack” in the keyword search on the right side of the page.
   * Locate the 'Install Ruby Stack on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Ruby Stack on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Ruby Stack installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Ruby Stack on Linux**.
