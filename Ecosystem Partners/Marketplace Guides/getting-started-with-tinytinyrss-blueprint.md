...
![Tiny Tiny RSS Logo](../../images/tinytinyrss-stack-logo.png)
...
1. Locate the Bitnami Tiny Tiny RSS Blueprint.
   ...
   * Search for “Tiny Tiny RSS” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami Tiny Tiny RSS on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami Tiny Tiny RSS on Linux” Blueprint.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami Tiny Tiny RSS on Linux**.
