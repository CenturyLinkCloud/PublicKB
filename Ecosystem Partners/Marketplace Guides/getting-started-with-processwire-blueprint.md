...
![ProcessWire Logo](../../images/processwire-stack-logo.png)
...
1. Locate the Bitnami ProcessWire Blueprint.
   ...
   * Search for “ProcessWire” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami ProcessWire on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami ProcessWire on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for ProcessWire installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami ProcessWire on Linux**.
