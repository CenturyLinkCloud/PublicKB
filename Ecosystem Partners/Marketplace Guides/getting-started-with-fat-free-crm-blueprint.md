...
![Fat Free CRM logo](../../images/fatfreecrm-stack-logo.png)
...
For more information, please visit [Fat Free CRM](http://www.fatfreecrm.com/).
...
1. Locate the Fat Free CRM Stack Blueprint.
   ...
   * Search for “Fat Free CRM” in the keyword search on the right side of the page.
   * Locate the 'Install Fat Free CRM on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Fat Free CRM on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Fat Free CRM installation.
