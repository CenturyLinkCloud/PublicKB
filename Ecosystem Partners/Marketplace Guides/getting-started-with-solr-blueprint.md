...
![Apache Solr logo](https://bitnami.com/assets/stacks/solr/img/solr-stack-220x234.png)
...
### Description
This CenturyLink Blueprint provides a click-through solution to install and configure Apache Solr on the Linux platform.

For more information, please visit [http://lucene.apache.org/solr/](http://lucene.apache.org/solr/)
...
1. **Locate the Apache Solr Stack Blueprint**
  ...
  2. Search for “Apache Solr” in the keyword search on the right side of the page.
  3. Locate the 'Install Apache Solr on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Apache Solr on Linux” Blueprint.**
...
Apache Solr Stack is available as a Script Package for deployment on an existing server based on your own sizing requirements or to support more advanced configurations such as customized Blueprint Workflows to repeatably deploy multiple stacks on servers.

#### Steps to deploy to an existing server
1. **Deploy or Identify an Existing Server**
Identify the server targeted for Apache Solr installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Apache Solr on Linux**.
