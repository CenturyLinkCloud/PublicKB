...
![Apache Solr logo](../../images/solr-stack-logo.png)
...
2. Choose and Deploy the Blueprint.
   * Click the “Install Apache Solr on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Apache Solr installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Apache Solr on Linux**.
