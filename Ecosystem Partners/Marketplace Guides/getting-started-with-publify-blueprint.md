...
![Publify Logo](../../images/publify-stack-logo.png)
...
### Description
Through the CenturyLink Blueprint integration, Publify provides a click-through solution to install and configure Publify on the Linux platform.
...
1. Locate the Bitnami Publify Blueprint.
   * Login to the Control Portal. From the Nav Menu on the left, click **Orchestration > Blueprints Library**.
   * Search for 'Publify' in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami Publify on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the 'Install Bitnami Publify on Linux' Blueprint.
...
Bitnami Publify is available as a Script Package for deployment on an existing server based on your own sizing requirements or to support more advanced configurations such as customized Blueprint Workflows to repeatably deploy multiple stacks on servers.

#### Steps
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Publify installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named 'Install Bitnami Publify on Linux'.
