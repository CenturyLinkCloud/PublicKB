...
1. Locate the Bitnami phpBB Stack Blueprint.
   ...
   * Search for “phpBB” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami phpBB on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami phpBB on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for phpBB installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami phpBB on Linux**.
