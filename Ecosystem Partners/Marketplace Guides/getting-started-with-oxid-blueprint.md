...
![OXID eShop logo](https://bitnami.com/assets/stacks/oxid/img/oxid-stack-220x234.png)
...
1. **Locate the Bitnami OXID eShop Stack Blueprint**
  ...
  2. Search for “OXID eShop” in the keyword search on the right side of the page.
  3. Locate the 'Install Bitnami OXID eShop on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Bitnami OXID eShop on Linux” Blueprint.**
