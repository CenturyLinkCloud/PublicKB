...
![eZ Publish Logo](../../images/ezpublish-stack-logo.png)
...
For more information, please visit [eZ Publish](http://ez.no/).
...
1. Locate the eZ Publish Stack Blueprint.
   ...
   * Search for “eZ Publish” in the keyword search on the right side of the page.
   * Locate the 'Install eZ Publish on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install eZ Publish on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for eZ Publish installation.
   * The Operating system must be supported by the Script Package.
   * See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. Select to Execute the Package on a Server Group.
   * Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install eZ Publish on Linux**.
