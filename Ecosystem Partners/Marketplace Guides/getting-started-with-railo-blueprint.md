...
![Railo Logo](../../images/railo-stack-logo.png)

### Technology Profile

### Description
Through the CenturyLink Blueprint integration, Railo provides a click-through solution to install and configure Railo on the Linux platform. Railop provides CFML is a tag-based Web scripting language supporting dynamic Web page creation and database access in a Web server environment. In the language, ColdFusion tags are embedded in HTML files.
...
1. Locate the Bitnami Railo Blueprint.
   ...
   * Search for “Railo” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami Railo on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami Railo on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Railo installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install Bitnami Railo on Linux**.
