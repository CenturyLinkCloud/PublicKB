...
![SugarCRM Logo](../../images/sugarcrm-stack-logo.png)
...
1. Locate the SugarCRM Stack Blueprint.
   ...
   * Search for “SugarCRM” in the keyword search on the right side of the page.
   * Locate the 'Install SugarCRM on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install SugarCRM on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for SugarCRM installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named **Install SugarCRM on Linux**.
