...
![Pimcore Logo](../../images/pimcore-stack-logo.png)

### Technology Profile

### Description
Through the CenturyLink Blueprint integration, Pimcore provides a click-through solution to install and configure Pimcore on the Linux platform. Pimcore brings outstanding digital experiences on the most flexible content management platform available. Manage and edit any type of digital content, for any device and channel in a 100% flexible and personalized way.
...
1. Locate the Bitnami Pimcore Stack Blueprint.
   ...
   * Search for “Pimcore” in the keyword search on the right side of the page.
   * Locate the 'Install Bitnami Pimcore on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Bitnami Pimcore on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for Pimcore installation.
...
2. Select to Execute the Package on a Server Group.
   * Packages can be executed on one more more servers in a Group.
     * Search for the public script package named **Install Bitnami Pimcore on Linux**.
