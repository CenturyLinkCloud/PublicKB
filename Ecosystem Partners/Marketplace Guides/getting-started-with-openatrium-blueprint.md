...
![Open Atrium logo](https://bitnami.com/assets/stacks/openatrium/img/openatrium-stack-220x234.png)

### Technology Profile

Open Atrium is your one stop shop to building a truly scalable collaborative workspace and intranet. It features everything your team needs to collaborate, build a knowledge base, discuss and debate ideas. Customize the look and feel, build workflow, set up notifications, build spaces and pages to share documents and mulitmedia, and get it all done in one place. If you're in the market for a collaboration solution that can be used by anyone in the organzation – from HR to engineering – you will want to try Open Atrium.
...
1. **Locate the Bitnami Open Atrium Stack Blueprint**
  ...
  2. Search for “Open Atrium” in the keyword search on the right side of the page.
  3. Locate the 'Install Bitnami Open Atrium on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Bitnami Open Atrium on Linux” Blueprint.**
...
Identify the server targeted for Open Atrium installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Bitnami Open Atrium on Linux**.
