...
![OpenCart logo](https://bitnami.com/assets/stacks/opencart/img/opencart-stack-220x234.png)
...
Through the CenturyLink Blueprint integration, Bitnami OpenCart Stack provides a click-through solution to install and configure OpenCart on the Linux platform.
...
1. **Locate the Bitnami OpenCart Stack Blueprint**
  ...
  2. Search for “OpenCart” in the keyword search on the right side of the page.
  3. Locate the 'Install Bitnami OpenCart on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Bitnami OpenCart on Linux” Blueprint.**
...
Identify the server targeted for OpenCart installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Bitnami OpenCart on Linux**.
