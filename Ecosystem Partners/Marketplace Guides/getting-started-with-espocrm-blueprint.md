...
![EspoCRM Logo](../../images/espocrm-stack-logo.png)
...
1. Locate the EspoCRM Stack Blueprint.
   ...
   * Search for 'EspoCRM' in the keyword search on the right side of the page.
   * Locate the 'Install EspoCRM on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the 'Install EspoCRM on Linux' Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for EspoCRM installation.
...
2. Select to Execute the Package on a Server Group.
   ...
   * Search for the public script package named 'Install EspoCRM on Linux'.
