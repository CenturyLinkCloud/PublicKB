...
<a href="https://bitnami.com/" rel="no-follow">Bitnami</a> has integrated their <a href="https://bitnami.com/stack/opencart" rel="no-follow">OpenCart stack</a> with the CenturyLink Cloud platform with a single-click deploy solution.  The purpose of this KB article is to help the reader take advantage of this integration to achieve rapid time-to-value for this OpenCart solution.
...
1. **Locate the Blueprint in the Blueprint Library**
  ...
  Starting from the CenturyLink Control Panel, navigate to the Blueprints Library. Search for **OpenCart on Linux** in the keyword search on the right side of the page.
...
7. **Deployment Complete**
  ...
  Once the Blueprint has finished executing on your server you may access OpenCart by navigating to your server via http.
...
### Deploying OpenCart on an existing server (alternate option)

OpenCart is available as a Blueprint Package for deployment on an existing server based on your own sizing requirements or to support more advanced configurations such as customized Blueprint Workflows to repeatably deploy multiple stacks on the same machines
...
1. **Deploy or Identify an Existing Server**
  ...
  Identify the server targeted for OpenCart installation.  Operating sustem must be linux.

  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**

  Packages can be executed on one more more servers in a group.  Search for the public script package named **Install OpenCart on Linux**.
...
**How do I access OpenCart for the first time?**
