{{{
  "title": "Getting Started with Osclass - Blueprint",
  "date": "06-30-2015",
  "author": "Bitnami",
  "attachments": [],
  "contentIsHTML": false
...
![Osclass logo](https://bitnami.com/assets/stacks/osclass/img/osclass-stack-220x234.png)

### Technology Profile
Osclass is your one-stop shop to building your own classifieds marketplace. Create a site with real estate ads, job listings, car classifieds, rentals, or just about anything you can imagine. With dozens of templates, themes and plugins, Osclass is fully customizable. After launching Osclass, be sure to check out the showcase on the Oeoego website (makers of Ossclass) to see stellar examples of Osclass in action.

### Description
This CenturyLink Blueprint provides a click-through solution to install and configure Osclass on the Linux platform.

For more information, please visit [http://osclass.org](http://osclass.org)
...
### Deploying Osclass on a New Server
Osclass is available as a Blueprint for deployment on a new server.

#### Steps to deploy to an existing server Blueprint
1. **Locate the Osclass Stack Blueprint**
  1. Starting from the CenturyLink Control Panel, navigate to the Blueprints Library.
  2. Search for “Osclass” in the keyword search on the right side of the page.
  3. Locate the 'Install Osclass on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Osclass on Linux” Blueprint.**
...
Osclass Stack is available as a Script Package for deployment on an existing server based on your own sizing requirements or to support more advanced configurations such as customized Blueprint Workflows to repeatably deploy multiple stacks on servers.

#### Steps to deploy to an existing server
1. **Deploy or Identify an Existing Server**
Identify the server targeted for Osclass installation.  The Operating system must be supported by the Script Package.  See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Osclass on Linux**.
