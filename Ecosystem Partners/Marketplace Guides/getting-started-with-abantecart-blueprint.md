...
![AbanteCart Logo](../../images/abantecart-stack-logo.png)
...
1. Locate the AbanteCart Blueprint.
   ...
   * Search for “AbanteCart” in the keyword search on the right side of the page.
   * Locate the 'Install AbanteCart on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install AbanteCart on Linux” Blueprint.
...
1. Deploy or Identify an Existing Server.
   * Identify the server targeted for AbanteCart installation.
