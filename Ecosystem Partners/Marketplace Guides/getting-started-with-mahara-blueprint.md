...
![Mahara logo](https://bitnami.com/assets/stacks/mahara/img/mahara-stack-220x234.png)
...
1. **Locate the Bitnami Mahara Stack Blueprint**
  ...
  2. Search for “Mahara” in the keyword search on the right side of the page.
  3. Locate the 'Install Bitnami Mahara on Linux' Blueprint

2. **Choose and Deploy the Blueprint. Click the “Install Bitnami Mahara on Linux” Blueprint.**
...
2. **Select to Execute the Package on a Server Group**
  1. Packages can be executed on one more more servers in a Group.  Search for the public script package named **Install Bitnami Mahara on Linux**.
