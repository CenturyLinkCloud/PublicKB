...
![Nginx Stack logo](../../images/nginxstack-stack-logo.png)
...
For more information, please visit [Nginx](http://nginx.org).
...
1. Locate the Nginx Stack Stack Blueprint.
   ...
   * Search for “Nginx Stack” in the keyword search on the right side of the page.
   * Locate the 'Install Nginx Stack on Linux' Blueprint.

2. Choose and Deploy the Blueprint.
   * Click the “Install Nginx Stack on Linux” Blueprint.
...
3. Configure the Blueprint.
   ...
   * Password
   * Nginx Port, e.g., 8088
   * Nginx SSL Port, e.g., 8043
   * PHP-FPM port, e.g., 9000
...
#### Steps to deploy to an existing server
   ...
   * Identify the server targeted for Nginx Stack installation. The Operating system must be supported by the Script Package.
   * See the [Creating a new enterprise cloud server](../../Servers/creating-a-new-enterprise-cloud-server.md) KB for more information on completing this step.

2. Select to Execute the Package on a Server Group.
   * Packages can be executed on one more more servers in a Group. Search for the public script package named **Install Nginx Stack on Linux**.
