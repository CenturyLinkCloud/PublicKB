...
1. **Locate the Blueprint in the Blueprint Library**
  ...
  Starting from the CenturyLink Control Panel, navigate to the Blueprints Library. Search for **MEAN on linux_TITLE** in the keyword search on the right side of the page.
...
3. **Set Required parameters.**
  ...
  <div style="margin:1em;color: #838383; background: #f2f2f2; margin:1em; padding: 1em; border:2px solid #e5e5e5;width:500px;">
    ...
    <label style="font-family: 'Open Sans', Helvetica, Arial, Sans-Serif; font-size:14px; margin: 7px 20px 7px 0; padding-top:7px;color:#333333; text-decoration:underline; text-transform:lowercase; float:left; width:160px;text-align:right;">MongoDB Port</label>
    <div style="float:left;margin-left:10px;">
      <input style="padding:4px 6px;width:250px;height:34px;" type="text" value="27017" disabled="disabled">
      <div style="margin-top:10px; color:#999; font-size:13px; line-height:15px;">MongoDB Server port</div>
    </div>
    <br style="clear:both;">
  </div>
...
2. ** Select to Execute the Package on a Server Group**
  ...
  Packages can be executed on one more more servers in a group.  Search for the public script package named **Install MEAN on linux_TITLE**.
