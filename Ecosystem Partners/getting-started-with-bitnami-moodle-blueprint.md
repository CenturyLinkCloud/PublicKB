...
Through the CenturyLink Blueprint integration, Bitnami Moodle Stack provides a click-through solution to install and configure Moodle on the Linux platform.

For more information, please visit http://moodle.org/
...
### Install Bitnami Moodle Stack on Linux Blueprint
1. Locate the Bitnami Moodle Stack Blueprint
  1. Starting from the CenturyLink Control Panel, navigate to the Blueprints Library.
  2. Search for “Moodle” in the keyword search on the right side of the page.
  3. Locate the 'Install Bitnami Moodle on Linux' Blueprint

2. Choose and Deploy the Blueprint. Click the “Install Bitnami Moodle on Linux” Blueprint.
