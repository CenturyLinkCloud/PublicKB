...
<img src="//d33np9n32j53g7.cloudfront.net/assets/stacks/phpbb/img/phpbb-stack-110x117-c5c8752aa11d4c6fa4fc9bf5057e8f42.png" style="border:0;float:right;max-width:250px">
...
### Deploying phpBB on a New Server

phpBB is available as a Blueprint for deployment on a **new server**.
...
1. **Locate the Blueprint in the Blueprint Library**
  ...
  Starting from the CenturyLink Control Panel, navigate to the Blueprints Library. Search for **phpBB on linux_TITLE** in the keyword search on the right side of the page.
...
3. **Set Required parameters.**
  ...
  <div style="margin:1em;color: #838383; background: #f2f2f2; margin:1em; padding: 1em; border:2px solid #e5e5e5;width:500px;">
    ...
    <label style="font-family: 'Open Sans', Helvetica, Arial, Sans-Serif; font-size:14px; margin: 7px 20px 7px 0; padding-top:7px;color:#333333; text-decoration:underline; text-transform:lowercase; float:left; width:160px;text-align:right;">phpBB forum name</label>
    <div style="float:left;margin-left:10px;">
      <input style="padding:4px 6px;width:250px;height:34px;" type="text" value="General" disabled="disabled">
      <div style="margin-top:10px; color:#999; font-size:13px; line-height:15px;">Forum name</div>
    </div>
    <br style="clear:both;">
  </div>
  ...
  <div style="padding: 1em;">
    <label style="font-family: 'Open Sans', Helvetica, Arial, Sans-Serif; font-size:14px; margin: 7px 20px 7px 0; padding-top:7px;color:#333333; text-decoration:underline; text-transform:lowercase; float:left; width:160px;text-align:right;">phpBB forum description</label>
    <div style="float:left;margin-left:10px;">
      <input style="padding:4px 6px;width:250px;height:34px;" type="text" value="A _little_ text to describe your forum" disabled="disabled">
      <div style="margin-top:10px; color:#999; font-size:13px; line-height:15px;">Forum Description</div>
    </div>
    <br style="clear:both;">
  </div>
...
7. **Deployment Complete**
  ...
  Once the Blueprint has finished executing on your server you may access phpBB by navigating to your server via http.
...
### Deploying phpBB on an existing server (alternate option)

phpBB is available as a Blueprint Package for deployment on an existing server based on your own sizing requirements or to support more advanced configurations such as customized Blueprint Workflows to repeatably deploy multiple stacks on the same machines
...
1. **Deploy or Identify an Existing Server**
  ...
  Identify the server targeted for phpBB installation.  Operating sustem must be linux.
...
2. ** Select to Execute the Package on a Server Group**
  ...
  Packages can be executed on one more more servers in a group.  Search for the public script package named **Install phpBB on linux_TITLE**.
...
**How do I access phpBB for the first time?**
