...
[Role Permissions Matrix](roles-permission-matrix.md). </p>
...
<p>For other tips on applying these roles to your organization along with a suggested breakdown of how many users might be in each role in your account, check out the [Practical Guide for Using Roles](practical-guide-for-using-roles.md). </p>
