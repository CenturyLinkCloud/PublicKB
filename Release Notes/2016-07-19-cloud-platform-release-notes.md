...
* __Relational DB: Point in Time Restore__
	...
	Customers are now able to restore a Relational DB instance to any point in time up to 10 minutes ago, as far back as one week or the customers' backup retention policy, whichever is shorter.
