...
<ol>
<li>If you haven't already, install the <a href="https://www.ctl.io/knowledge-base/afv1/appfog-cli-tool-manual/">af command line tool</a> and log in.</li>
...
<blockquote><strong>Note: </strong>If you intend to use SSL with your site, <strong><em>STOP HERE</em></strong> and go check out our <a href="https://www.ctl.io/knowledge-base/afv1/configuring-ssl-for-a-custom-domain/">SSL for Custom Domains</a> documentation. It includes information on the different DNS configuration needed for SSL Endpoint termination.</blockquote>
