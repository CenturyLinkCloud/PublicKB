...
<p>You can also stop, start, and restart apps, add services, modify environment variables, etc. The only command Team members don't have access to is <code>af passwd</code>. To see the full list of commands, check out the <a href="https://www.ctl.io/knowledge-base/afv1/getting-started-overview/">af cli doc</a>.</p>
