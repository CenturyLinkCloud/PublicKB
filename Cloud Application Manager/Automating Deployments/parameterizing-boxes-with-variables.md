...
* Any Box Instance. In the Value drop-down, select **Any Box Instance** to bind to any active instance in the current workspace.
    ...
    ![Adding Binding type variable](../../images/cloud-application-manager/parameterizingboxeswithvariables2.png)
...
![Adding Port type variable](../../images/cloud-application-manager/parameterizingboxeswithvariables3.png)
...
![Adding Text type variable](../../images/cloud-application-manager/parameterizingboxeswithvariables4.png)
...
![Adding File type variable](../../images/cloud-application-manager/parameterizingboxeswithvariables5.png)
...
![Adding Options type variable](../../images/cloud-application-manager/parameterizingboxeswithvariables6.png)
...
![Adding Password type variable](../../images/cloud-application-manager/parameterizingboxeswithvariables7.png)
...
![Adding Number type variable](../../images/cloud-application-manager/parameterizingboxeswithvariables8.png)
