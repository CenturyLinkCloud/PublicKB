...
### Overview
The following process automates the configuration of your AWS account for Cloud Application Manager Analytics functionality by using native AWS CloudFormation functionality. You can inspect the code snippet [here](https://s3.us-east-2.amazonaws.com/ctl-cloudanalytics/CTLCloudAnalyticsIAMPolicy.template.json).
...
#### CenturyLink Cloud Analytics Configuration Steps:
1. Open the CloudFormation template found [here](https://console.aws.amazon.com/cloudformation/home?region=us-east-2#/stacks/new?stackName=CTL-CloudAnalytics-IAM-Stack&templateURL=https%3A%2F%2Fs3.us-east-2.amazonaws.com%2Fctl-cloudoanalytics%2FCTLCloudAnalyticsIAMPolicy.template.json).
...
2. Copy the “CTLCloudAnalyticsRoleARN” Key’s Value (i.e., AWS ARN).
