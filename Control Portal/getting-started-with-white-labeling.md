...
This logo appears on the sign in page to the Control Portal for accounts using a [subdomain that features an account alias](../release-notes/2015-03-05-cloud-platform-release-notes/).
